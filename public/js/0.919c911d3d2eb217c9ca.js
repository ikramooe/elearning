...
//
//
/* harmony default export */ __webpack_exports__["default"] = (_name$mounted$mounted = {
  name: "Navbar",
...
}, _defineProperty(_name$mounted$mounted, "mounted", function mounted() {
  var _this2 = this;
...
}), _defineProperty(_name$mounted$mounted, "props", {
  auth: Object
}), _defineProperty(_name$mounted$mounted, "data", function data() {
  return {
    formations: {},
    total: 0,
    items: [{
...
}), _defineProperty(_name$mounted$mounted, "methods", {
  ...
  update: function update() {
    ...
    axios.get('/ss').then(function (response) {
      _this3.formations = response.data.formations;
      _this3.total = response.data.total;
    });
  }
}), _name$mounted$mounted);
