...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    addContent: function addContent(title) {
      ...
      this.form_contenu.section = this.content[0].sectionTitle;
