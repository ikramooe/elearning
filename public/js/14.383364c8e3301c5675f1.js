...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    addContent: function addContent(title) {
      this.getParentSection(this.content, title, this.contentTitle, this.contentType, this.id, this.url);
      ...
      this.formData.append('file', this.file); //this.$inertia.post(route('formation.contenu'),this.formData);
    }
  }
});
