                ...
                _c(
                  ...
                  _vm._l(_vm.modules, function(module) {
                    return _c(
                      ...
                      [
                        _vm._v(" "),
                        _vm._l(_vm.modul.sections, function(section) {
                          return _c(
                            "v-list-group",
                            {
                            ...
                            [
                              _vm._v(" "),
                              _vm._l(section.sectionContent, function(datas) {
                                return [
                                  _vm.itemContent.type === "video"
                                    ? _c(
                                        "v-list-item",
                                        {
                                          key: _vm.i,
                                          ...
                                          on: {
                                            click: function($event) {
                                              _vm.videoId = _vm.itemContent.id
                                  ...
                                  _vm.itemContent.type === "PDF"
                                    ? _c(
                                        "v-list-item",
                                        {
                                          ...
                                          on: {
                                            click: function($event) {
                                              _vm.videoId = _vm.itemContent.url
                                              _vm.contentType = "PDF"
                                            }
                                          }
                                        },
