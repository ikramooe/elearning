...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (_methods = {
  ...
  }, _defineProperty(_methods, "newpdf", function newpdf() {
    console.log(document.getElementById('loadvideo').files[0]);
    this.file = document.getElementById('loadvideo').files[0];
    this.form_contenu.type = "pdf";
  }), _defineProperty(_methods, "getParentModule", function getParentModule(myArray, prop, val, sectionTitle) {
  ...
  }), _defineProperty(_methods, "getParentSection", function getParentSection(myArray, prop, val, contentTitle, type, id, url) {
  ...
  }), _defineProperty(_methods, "addModule", function addModule() {
    this.content.push({
    ...
    this.moduleTitle = "";
  }), _defineProperty(_methods, "addSection", function addSection(title) {
    ...
    this.sectionTitle = "";
  }), _defineProperty(_methods, "addContent", function addContent(title) {
    ...
    this.$inertia.post(route('formation.contenu'), this.form_contenu);
  }), _methods)
});
