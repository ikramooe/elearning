...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      image: '/upload/'.$page.auth.user.image,
      activatedTab: null,
      item: 0,
      items: [{
        text: "Profile",
