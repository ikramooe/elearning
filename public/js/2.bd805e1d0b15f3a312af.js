...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("v-card-title", [_vm._v(_vm._s(_vm.forma.type) + ".")]),
      _vm._v(" "),
      _c("v-card-text", [
