  ...
  return {
    ...
    methods: {
      ...
      renderChart: function renderChart(data, options) {
        ...
        this.$data._chart = new !(function webpackMissingModule() { var e = new Error("Cannot find module 'chart.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(this.$refs.canvas.getContext('2d'), {
          type: chartType,
          data: data,
          options: options,
