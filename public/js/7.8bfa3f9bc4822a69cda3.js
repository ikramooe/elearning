  ...
  methods: {
    pay: function pay() {
      ...
      Object(vue_stripe_elements_plus__WEBPACK_IMPORTED_MODULE_0__["createToken"])(options).then(function (result) {
        ...
        _this.$inertia.post(route('user.payment', _this.form));
      });
    }
  }
});
  ...
  return _c(
    ...
    [
      _c("card", {
        ...
        attrs: {
          stripe:
            "pk_test_51GxHgjITAqKCLKS0TWaQQRMl5I3Y7z0wTNQ3iJbpGVjsXvYCucKvyOkPCHO6n9wrgEWh4NzBAJnoUrehpaOaronY001j85Xp42",
