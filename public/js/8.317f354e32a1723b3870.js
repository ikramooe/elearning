...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    createUser: function createUser() {
      alert('rrrrrr'); //this.$inertia.post($route('users.register',this.form));
    }
  }
});
